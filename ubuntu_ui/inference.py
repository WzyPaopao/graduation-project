...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton_5 = QtWidgets.QPushButton(self.gridLayoutWidget)  # 开始推理
        ...
        self.pushButton_4 = QtWidgets.QPushButton(self.gridLayoutWidget)  # 解释器环境
        ...
        self.pushButton_2 = QtWidgets.QPushButton(self.gridLayoutWidget)  # 环境参数
    ...
    def init_slot(self):
        self.pushButton_2.clicked.connect(self.show_cmd)
        self.pushButton_5.clicked.connect(self.inf)

    def show_cmd(self):
        """
        python -c "import sys;print(sys.executable);print(sys.version)"
        /home/wzy/miniconda3/envs/second_env/bin  python -c "import sys;print(sys.executable);print(sys.version)"
        """
        cmd = self.lineEdit_2.text()
        res = os.popen(cmd).read().strip()
        text_browser_append_text(self.textBrowser, res)

    def inf(self):
        t = 'load checkpoint from local path: checkpoints/hv_second_secfpn_6x8_80e_kitti-3d-car_20200620_230238-393f000c.pth'
        text_browser_append_text(self.textBrowser, t)
