...
class Ui_Form(QWidget):
    def setupUi(self, Form):
        ...
        self.textBrowser.setGeometry(QtCore.QRect(10, 20, 551, 301))
        ...
        self.graphicsView_2.setGeometry(QtCore.QRect(10, 20, 501, 301))
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(20, 30, 411, 371))
        ...
        self.lineEdit = QtWidgets.QLineEdit(self.gridLayoutWidget)  # 数据路径
        ...
        self.lineEdit_3 = QtWidgets.QLineEdit(self.gridLayoutWidget)  # 标签路径
        ...
        self.lineEdit_4 = QtWidgets.QLineEdit(self.gridLayoutWidget)  # 解释器路径
        ...
        self.lineEdit_2 = QtWidgets.QLineEdit(self.gridLayoutWidget)  # 环境参数
        ...
        self.graphicsView.setGeometry(QtCore.QRect(10, 20, 621, 381))
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox.setItemText(2, _translate("Form", "SECOND"))
    ...
    def init_slot(self):
        self.pushButton_2.clicked.connect(self.test_python_env)
        # self.pushButton_2.clicked.connect(self.test)
        self.pushButton_5.clicked.connect(self.show_message)

    def test_python_env(self):
        cmd_code = self.lineEdit_2.text()
        res = os.popen(cmd_code).read().strip()
        tool.text_browser_append_text(self.textBrowser, res)

    def show_message(self):
        txt = 'Use load_from_local loader'
        tool.text_browser_append_text(self.textBrowser, txt)
