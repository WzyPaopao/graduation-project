...
class Ui_Form(QWidget):
    def setupUi(self, Form):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 411, 241))
        font = QtGui.QFont()
        font.setFamily("黑体")
        ...
        self.pushButton_2.clicked.connect(self.showMessageBox)
    ...
    def showMessageBox(self):
        alg_name = self.lineEdit.text()
        QMessageBox.information(self, "算法注册", alg_name+"注册成功", QMessageBox.Yes, QMessageBox.Yes)
